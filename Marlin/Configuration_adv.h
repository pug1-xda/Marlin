...
//#define LCD_SET_PROGRESS_MANUALLY
  ...
  #define LCD_PROGRESS_BAR              // Show a progress bar on HD44780 LCDs for SD printing
    ...
    #define PROGRESS_BAR_MSG_TIME 8000    // (ms) Amount of time to show the status message
 ...
 */
  ...
  #define TOOLCHANGE_PARK
    ...
    #define TOOLCHANGE_PARK_XY    { X_MIN_POS + 25, Y_MAX_POS - 75, Z_MAX_POS - 25 }
    #define TOOLCHANGE_PARK_XY_FEEDRATE 2000  // (mm/m)
  #endif
#endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_RETRACT_FEEDRATE         2000  // (mm/s) Initial retract feedrate.
  ...
  #define PAUSE_PARK_NO_STEPPER_TIMEOUT      300  // Enable for XYZ steppers to stay powered on during filament change.
...
#define CUSTOM_USER_MENUS
  ...
  #define CUSTOM_USER_MENU_TITLE "Beats & Peices"
