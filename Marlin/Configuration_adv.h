...
#define HOTEND_IDLE_TIMEOUT
  ...
  #define HOTEND_IDLE_TIMEOUT_SEC (11*60)    // (seconds) Time without extruder movement to trigger protection
...
#define CASE_LIGHT_ENABLE
  ...
  #define CASE_LIGHT_PIN P0_10                  // Override the default pin if needed
...
#define HOMING_BUMP_MM      { 7, 7, 4 }       // (mm) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR { 2, 2, 4 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)

#define HOMING_BACKOFF_POST_MM { 50, 50, 5 }  // (mm) Backoff from endstops after homing
...
#define FWRETRACT
  ...
  #define RETRACT_FEEDRATE                95  // (mm/s) Default feedrate for retracting
  #define RETRACT_ZRAISE                0.65  // (mm) Default retract Z-raise
  #define RETRACT_RECOVER_LENGTH        0.10  // (mm) Default additional recover length (added to retract length on recover)
  ...
  #define RETRACT_RECOVER_FEEDRATE        95  // (mm/s) Default feedrate for recovering from retraction
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_UNLOAD_PURGE_DELAY       4500  // (ms) Delay for the filament to cool after retract.
...
#define CUSTOM_MENU_CONFIG
  ...
  #define CUSTOM_MENU_CONFIG_TITLE "Connectivity"
  #define CUSTOM_MENU_CONFIG_SCRIPT_DONE "Config Done"
