...
#define HOMING_BACKOFF_POST_MM { 70, 64, 5 }  // (mm) Backoff from endstops after homing
...
#define FWRETRACT
  ...
  #endif
  #define RETRACT_LENGTH 5.25             // (mm) Default retract length (positive value)
  ...
  #define RETRACT_RECOVER_FEEDRATE 65    // (mm/s) Default feedrate for recovering from retraction
