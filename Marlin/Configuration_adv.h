...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN 57           // Set a custom pin for the controller fan
...
#define HOMING_BACKOFF_MM { 91, 89, 5 }  // (mm) Move away from the endstops after homing
